...
import OptionSelection from './components/ChatApi/OptionSelection';
import { arrayItems } from './components/ChatApi/AiOptions'
import './App.css'
import MainChat from './components/ChatApi/MainChat';
...
// 
  ...
  return (
    ...
    <store.Provider value={{token,setToken,profile,setProfile,sort,setSort,votes,setVotes,search,setSearch}} >
        <Router>
            <Navbar />
            <Routes>
              ...
              <Route exact path='/trysomethingnew' element={<MainChat /> } />
